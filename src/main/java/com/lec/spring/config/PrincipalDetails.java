...
public class PrincipalDetails implements UserDetails, OAuth2User {
  ...
  public Collection<? extends GrantedAuthority> getAuthorities() {
    ...
    List<Authority> list = userService.selectAuthoritiesById(user.getId()); // DB에서 user 의 권한(들_ 읽어오기
  ...
  // -----------------------------------------------------------------
  // OAuth2User implement 하게 되면 구현할 메소드
