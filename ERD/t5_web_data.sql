...
INSERT INTO t5_user (username, password, name, email) VALUES
    ('USER1', '$2a$10$WvSJ8.4wyVJpVihNIYMHDegiirUrM.yddNbZeLbMfLL3y5gNngF0S', '회원1', 'user1@mail.com'),
    ('USER2', '$2a$10$od0XY9OQ2X1ziwdQLqQ0A.opI4LZsLhGQEAvr20WzHlBmHMbKMkmC', '회원2', 'user2@mail.com'),
    ('ADMIN1', '$2a$10$FPGKyTZqk341n2SlBUrHROqirEnoYtImne6eTO4GxnjT/TaqgI11W', '관리자1', 'admin1@mail.com')
;
